...
class SelectDomain:
    ...
    DOMAIN_CENTRES_RP_LONG_LAT = { domain_name: cp_model_rotated_pole.transform_point(*lon_lat, src_crs=platecarree) for domain_name, lon_lat in DOMAIN_CENTRES_LON_LAT.items() }
    ...
    def run(self, ds):
        ...
        centre_ds = ds.sel(grid_longitude=360.0+centre_rp_lon_lat[0], grid_latitude=centre_rp_lon_lat[1], method="nearest")
