...
class Regrid:
    ...
    def run(self, ds):
        ...
        vars.update({target_grid_mapping: (self.target_ds[target_grid_mapping].dims, self.target_ds[target_grid_mapping].values, self.target_ds[target_grid_mapping].attrs)})
