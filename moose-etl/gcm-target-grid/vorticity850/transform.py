...
target_grid_path = Path("../../../src/ml_downscaling_emulator/utils/target-grids/60km/global/vorticity850/moose-grid.nc")

# convert pp data to netcdf and open with xr
target_cube = iris.load_cube(working_grid_pp_path, constraint=iris.Constraint(pressure=850.0))
